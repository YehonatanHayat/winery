...
//               {role === 'admin' && (
//         <div>
//           <button onClick={isEditing ? handleSave : handleEditClick} className={`info-page-button info-page-button-save-unique`}>
...
//       {role !== 'admin' && (
//         <div>
//           <button onClick={() => navigate('/orders')} className="info-page-button info-page-button-order-unique">
//             Place an Order
//           </button>

//           <button onClick={() => navigate('/')} className="info-page-button info-page-button-home-unique">
//             Home Page
//           </button>
//         </div>
//       )}
